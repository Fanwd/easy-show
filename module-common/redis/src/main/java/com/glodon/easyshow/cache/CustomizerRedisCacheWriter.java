...
/**
 * @ClassName CustomizerRedisCacheWriter
 * @Description 自定义RedisCacheWriter
 * @Author fanwd
 * @Date 2019/10/30 19:35
 **/
public class CustomizerRedisCacheWriter implements RedisCacheWriter {
     ...
     */
    CustomizerRedisCacheWriter(RedisConnectionFactory connectionFactory) {
     ...
     *                          to disable locking.
     */
    CustomizerRedisCacheWriter(RedisConnectionFactory connectionFactory, Duration sleepTime) {
